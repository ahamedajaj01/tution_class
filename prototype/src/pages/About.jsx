    ...
    <div className="bg-white font-sans text-slate-900">
      ...
      <section className="relative h-[500px] flex items-center justify-center text-center px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl">
          <h1 className="text-5xl md:text-6xl font-black text-[#004047] mb-6">About Our Center</h1>
          <p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-8">
            We are a respected educational provider located in the heart of Dartford. 
      ...
      <section className="py-20 px-6 bg-[#f4fafa]">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-16 items-center">
          ...
          <div className="hidden md:block">
            <img src="https://images.unsplash.com/photo-1497633762265-9d179a990aa6?q=80&w=600" alt="Education" className="rounded-full border-8 border-white shadow-2xl animate-pulse" />
          </div>
          <div className="space-y-12">
            {[ 
      ...
      <section className="py-20 px-6 bg-[#f4fafa]">
        <div className="max-w-7xl mx-auto flex justify-between items-end mb-12">
          ...
          <div className="flex gap-2">
            <button className="p-3 rounded-full border border-[#2ecc71] text-[#2ecc71] hover:bg-[#2ecc71] hover:text-white transition-colors"><ChevronLeft /></button>
            <button className="p-3 rounded-full bg-[#2ecc71] text-white hover:bg-[#27ae60] shadow-md"><ChevronRight /></button>
          </div>
        </div>
        <div className="flex gap-6 overflow-x-auto pb-10 [&::-webkit-scrollbar]:hidden">
          {[1,2,3,4].map(i => (
            <div key={i} className="min-w-[350px] bg-white p-10 rounded-2xl shadow-sm border border-slate-100">
              ...
              <h4 className="font-bold text-[#004047] text-xl mb-4">Excellent Tutors!</h4>
              <p className="text-slate-500 leading-relaxed italic mb-6">"The personalized support here has helped my child gain confidence and excel in their 11+ exams."</p>
              <div className="font-bold text-[#004047]">Parent {i}</div>
            </div>
          ))}
        </div>
      </section>
